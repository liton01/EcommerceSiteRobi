      ...
      <section className="bg-white py-10">
        <div className="container max-w-screen-xl mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-5">
            ...
            <main>
              <h2 className="font-semibold text-2xl mb-4 text-black">{product?.name}</h2>
              ...
              <ul className="mb-5">
                <li className="mb-1">
                  {" "}
                  <b className="font-medium w-36 inline-block text-black">Stock</b>
                  {inStock ? (
                ...
                <li className="mb-1">
                  {" "}
                  <b className="font-medium w-36 inline-block text-black">Category:</b>
