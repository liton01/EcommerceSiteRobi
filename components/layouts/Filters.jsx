...
const Filters = () => {
  ...
  return (
    <aside className="md:w-1/2  px-8 bg-white">
      <a
      ...
      <div className="hidden md:block px-6 py-4 border border-gray-200 bg-white rounded shadow-sm">
        <h3 className="font-semibold mb-2 text-blue-500 ">Price ($)</h3>
      ...
      <div className="hidden md:block px-6 py-4 border border-gray-200 bg-white rounded shadow-sm">
        <h3 className="font-semibold mb-2 text-green-500">Category</h3>
        ...
        <h3 className="font-semibold mb-2 text-red-500">Ratings</h3>
        <ul className="space-y-1">
          <li>
